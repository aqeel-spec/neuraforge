          ...
          return (
            <div key={option.value} className="flex items-center gap-2">
              <input
                ...
                disabled={disabled}
                className="h-4 w-4 border-slate-300 dark:border-zinc-600 text-indigo-600 outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              />
