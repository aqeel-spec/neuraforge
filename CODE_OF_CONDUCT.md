...
[private reporting form](https://github.com/aqeel-spec/neuraforge/security/advisories/new). Begin
the report title with **Code of Conduct** so maintainers route it correctly. Do not publish
sensitive conduct reports in an issue or discussion.

<!-- MAINTAINER TODO: GitHub private vulnerability reporting must remain enabled until a dedicated,
     monitored conduct mailbox or form is published. Update this section before changing that
     repository setting. -->
